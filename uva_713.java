...
public class Main {
    ...
    public static void main(String[] args) throws Exception {
        ...
        for (int i = 0; i < n; i++) {
            ...
            BigInteger ans=new BigInteger(String.valueOf(a)).add(new BigInteger(String.valueOf(b)));
            StringBuilder tmp=new StringBuilder(ans.toString()).reverse();
            out.println(new BigInteger(String.valueOf(tmp)));
