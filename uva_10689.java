...
public class Main {
    ...
    public static void main(String[] args) throws Exception {
        ...
        for (int i = 0; i <x ; i++) {
            ...
            if (m==2)n%=300;
            if (m==1)n%=60;
            BigInteger ans=fib(n-1).multiply(BigInteger.valueOf(a));
            ans=ans.add(fib(n).multiply(BigInteger.valueOf(b)));
            BigInteger t=new BigInteger("10").pow(m);
            ans=ans.mod(t);
            out.println(ans);
    ...
    static BigInteger[] fibs=new BigInteger[15001];
    static void sieveFib(){
